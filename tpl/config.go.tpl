...
var cluster1 = ClusterConfig{
			...
			clusterEndpoint: "{{ op://cohorts/cdi-101-team11-platform-sandbox-us-east-2/cluster-endpoint }}",
			base64CertificateAuthorityData: "{{ op://cohorts/cdi-101-team11-platform-sandbox-us-east-2/base64-certificate-authority-data }}",
		}
...
const (
	...
	IdpIssuerUrl								    = "https://dev-coj6inhiw5owgtxz.us.auth0.com/"
	...
	DefaultCluster                  = "sandbox-us-east-2"
